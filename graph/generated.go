...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		SignIn        func(childComplexity int, input model.UserSignIn) int
	}
...
type MutationResolver interface {
	...
	SignIn(ctx context.Context, input model.UserSignIn) (*model.User, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.signIn":
		...
		return e.complexity.Mutation.SignIn(childComplexity, args["input"].(model.UserSignIn)), true
...
func (ec *executionContext) field_Mutation_signIn_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 model.UserSignIn
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNUserSignIn2graphqlᚋgraphᚋmodelᚐUserSignIn(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Company_foundedYear(ctx context.Context, field graphql.CollectedField, obj *model.Company) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Company_foundedYear(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Company_foundedYear(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Company",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) fieldContext_Mutation_createCompany(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "foundedYear":
				return ec.fieldContext_Company_foundedYear(ctx, field)
			case "location":
...
func (ec *executionContext) _Mutation_signIn(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().SignIn(rctx, fc.Args["input"].(model.UserSignIn))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputNewCompany(ctx context.Context, obj interface{}) (model.NewCompany, error) {
	...
	fieldsInOrder := [...]string{"companyName", "foundedYear", "location", "address", "userId"}
...
func (ec *executionContext) unmarshalInputUserSignIn(ctx context.Context, obj interface{}) (model.UserSignIn, error) {
	var it model.UserSignIn
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}
...
func (ec *executionContext) _Company(ctx context.Context, sel ast.SelectionSet, obj *model.Company) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "foundedYear":
			out.Values[i] = ec._Company_foundedYear(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "location":
...
func (ec *executionContext) unmarshalNUserSignIn2graphqlᚋgraphᚋmodelᚐUserSignIn(ctx context.Context, v interface{}) (model.UserSignIn, error) {
	res, err := ec.unmarshalInputUserSignIn(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}
